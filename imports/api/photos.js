...
if (Meteor.isServer) {
	...
	Meteor.publish('single_cluster_photos', function clusterPhotos(clusterId) {
		...
		return LogicalImages.find({$or: id_or_statement}, {fields: {'datetime': 1, 'latitude': 1, 'longitude': 1, 'resized_uris': 1, 'interest_score': 1, 'openfaces': 1, 'all_photos': 1, 'geolocation': 1, 'size': 1, 'place': 1}});
	});
